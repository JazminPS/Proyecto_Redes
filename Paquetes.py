        ...
        for grado in range(H-1,-1,-1):
            for nodo in range(0,N[n]):
                if Nodos[nodo,grado] > 0:
                    contendientes[nodo] = randint(0,W[w]-1)
                else:
            ...
            colisiones = [indice for indice, item in enumerate(contendientes) if item == nodoGanador and item != None]#busca que contendientes tienen el mismo número de contador
            #print(colisiones)
